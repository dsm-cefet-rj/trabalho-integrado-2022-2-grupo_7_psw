...
class NewsEditor extends React.Component {
    ...
    render() {
        ...
        console.log(convertToRaw(editorState.getCurrentContent())); //converte pra objeto que pode ser salvo e desconvertido.
        ...
        return (
            <div>
                ...
                <div className="RichEditor-root">
                    ...
                    <button style={styleButton}>Publish it!</button>
                </div>
